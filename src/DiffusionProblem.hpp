...
class DiffusionProblem
{
    ...
    public:
        DiffusionProblem(double Lt, double Lx, double Ly, std::function<double(double,double)> getD, std::function<double(double,double)> getInitial, std::function<double(double,double)> getf, std::function<double(double)> getBoundaryx0, std::function<double(double)> getBoundaryx1, std::function<double(double)> getBoundaryy0, std::function<double(double)> getBoundaryy1);
        double getLt() const;
        double getLx() const;
        double getLy() const;
